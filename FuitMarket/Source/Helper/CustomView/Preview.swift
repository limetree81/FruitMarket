...
//  FuitMarket
//
//  Created by Limetree on 2024/04/26.
//
...
struct Preview<V: View>: View {
    ...
    private func previewSource(device: Device) -> some View {
        source.previewDevice(PreviewDevice(rawValue: device.rawValue)).previewDisplayName(device.rawValue)
    }
}
...
struct Preview_Previews: PreviewProvider {
    static var previews: some View {
        ...
        Preview(source: Text("Hello, SwiftUI!"), devices: [.iPhone11])
